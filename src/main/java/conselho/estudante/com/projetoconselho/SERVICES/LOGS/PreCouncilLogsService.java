...
import conselho.estudante.com.projetoconselho.REPOSITORIES.LOGS.PreCouncilLogsRepository;
...
public class PreCouncilLogsService {
     ...
     * @return {@link Boolean} se o log foi criado ou nao
     */
    public boolean create(User actor, PreCouncil target, String type) {
