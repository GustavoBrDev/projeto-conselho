...
/**
 * Controller para gerenciamento de logs de Feedbacks
...
public class FeedbackLogsController {
    ...
    @GetMapping()
    public ResponseEntity<Page<FeedbackLogs>> findAll(Pageable pageable) {
    ...
    @ApiResponse(responseCode = "500", description = "Erro interno do servidor")
    @GetMapping("/actor")
    public ResponseEntity<Page<FeedbackLogs>> findByActor(
    ...
    public ResponseEntity<Page<FeedbackLogs>> findByType(
    ...
    @ApiResponse(responseCode = "200", description = "Logs encontrados com sucesso",
            content = @Content(schema = @Schema(implementation = FeedbackLogs.class),
                    examples = @ExampleObject(value = "{\"id\": \"string\", \"actor\": {\"id\": 1, \"name\": \"Gustavo Stinghen\", \"registration\": 123456, \"email\": \"7G9Gt@example.com\", \"password\": \"123456\", \"image\": \"https://example.com/image.jpg\"}, \"target\": {\"id\": 1, \"name\": \"Conselho de Classe\"}, \"type\": \"CREATE\", \"timestamp\": \"2023-03-17T14:30:00.000Z\", \"createdAt\": \"2023-03-17T14:30:00.000Z\", \"changes\": [{\"field\": \"nome\", \"oldValue\": \"Conselho de Classe\", \"newValue\": \"Conselho de Classe Atualizado\"}]}")))
    @GetMapping("/target")
    public ResponseEntity<Page<FeedbackLogs>> findByTarget(
            @RequestBody @Parameter(description = "Alvo do log", required = true, content = @Content(schema = @Schema(implementation = Feedback.class)), example = "{\"id\": 1, \"name\": \"Conselho de Classe\"}") Feedback target,
            Pageable pageable) {
