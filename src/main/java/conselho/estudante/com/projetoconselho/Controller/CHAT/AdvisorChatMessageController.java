...
public class AdvisorChatMessageController {
    ...
    @PostMapping
    public ResponseEntity<ChatMessageResponseDTO> postMessage(@RequestBody @Valid AdvisorChatMessageRequestDTO message) {
        try {
    ...
    @ApiResponse (responseCode = "500", description = "Erro interno do servidor")
    @GetMapping
    public ResponseEntity<Page<ChatMessageResponseDTO>> findAll(@PageableDefault(size = 20, sort = "timestamp") Pageable pageable) {
        try {
    ...
    public ResponseEntity<Page<ChatMessageResponseDTO>> findByAdvisor(@PathVariable Long id, @PageableDefault(size = 20, sort = "timestamp") Pageable pageable) {
        try {
    ...
    @ApiResponse (responseCode = "500", description = "Erro interno do servidor")
    @GetMapping("{/id}")
    public ResponseEntity<ChatMessageResponseDTO> findById(@PathVariable Long id) {
        try {
    ...
    @ApiResponse (responseCode = "500", description = "Erro interno do servidor")
    @DeleteMapping("{/id}")
    public ResponseEntity<ChatMessageResponseDTO> delete(@PathVariable Long id) {
        try {
